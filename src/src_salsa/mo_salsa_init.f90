...
CONTAINS
  ...
  SUBROUTINE set_icebins()
    ...
    tmplolim = (/40.,80.,160., 240.,320.,400., 500./)*1.e-6
    tmphilim = (/80.,160.,240., 320.,400.,500., 1000./)*1.e-6
  ...
  SUBROUTINE define_salsa(level)
    ...
    NAMELIST /salsa/  &
         ...
         fixinc,      & ! Constant ice number concentration (fixinc > 0 #/L) is maintained by converting cloud droplets to ice
